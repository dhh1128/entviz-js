...
**v18**) — visualize high-entropy values as comparable SVG diagrams — plus a
...
**113/113 Tier A** (render model) and **106/106 Tier B** (canonical raster) vectors
pass — the whole v18 corpus, 96 render vectors plus 9 error vectors, with no skip
list and no subset. The **complete parser dispatch** is
...
(`SPEC_VERSION` in `packages/core/src/entviz.ts`, currently **v18**). The spec
...
As of this writing this port targets **v18**, matching the reference: the full
