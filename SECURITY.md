...
1. Go to the [**Security** tab](https://github.com/dhh1128/entviz-js/security) of this repository.
...
`@entviz/core` (and `@entviz/react`) are pre-1.0 and ship from the `main`
branch. Security fixes are applied to `main` and released as a new version;
there are no long-term support branches. Please ensure you are running the
